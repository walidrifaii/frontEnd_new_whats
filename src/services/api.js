...
export const getAdminServiceAccounts = (parentId) => api.get(`/admin/users/${parentId}/service-accounts`);
...
export const setUserSourceSwitch = (id, allow) => api.patch(`/admin/users/${id}/source-switch`, { allow });
export const addUserSource = (id, data) => api.post(`/admin/users/${id}/sources`, data);
export const setUserSourceEnabled = (id, source, enabled) => api.patch(`/admin/users/${id}/sources`, { source, enabled });
export const setUserSourceNumber = (id, source, phoneNumberId) =>
  api.patch(`/admin/users/${id}/sources`, { source, phoneNumberId });
export const deleteUserSource = (id, source) => api.delete(`/admin/users/${id}/sources/${encodeURIComponent(source)}`);
...
export const assignAdminNumberUser = (id, userId, action) =>
  api.patch(`/admin/numbers/${id}/assign`, { userId, action });
export const updateAdminNumberBalance = (id, data) => api.patch(`/admin/numbers/${id}/balance`, data);
